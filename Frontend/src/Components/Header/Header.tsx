...
const Header: React.FC = () => {
    ...
    const cartId = JSON.parse(localStorage.getItem('userInfo'))
    return (
        <div className='header__field'>
            <div className="container">
                <div className="header__icon">
                            ...
                            <svg width="44" height="38" viewBox="0 0 44 38" fill="none" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                                        <use xlinkHref="#image0_128_53" transform="scale(0.0227273 0.0263158)"/>
                                    </pattern>
                    ...
                    <div className='mhc'>
                        <button onClick={() => dispatch(setMenuStatus(menu))} className='svg'>
                        ...
                        {
                            localStorage.getItem('authStatus') === 'active' ?
                                <NavLink to='/Profile'>
                                ...
                                <NavLink to='/Login' style={{cursor: 'pointer'}}>
                                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                         width="33" height="33" viewBox="0 0 1280.000000 1280.000000"
...
-133 34 -196 14z"/>
                        ...
                        <NavLink to={login.authStatus === 'active' ? '/Cart/' + cartId._id : '/'} className='header__cart__link'>
                            ...
                            <span className='header__cart__count'>{totalCount}</span>
                        </NavLink>
                    </div>
                </div>
            </div>
