...
const addToCart = (e) => {
    ...
    const itemPhoto = item.getElementsByClassName('card__img')
    const itemText = item.getElementsByClassName('text-box')
    console.log(itemText, itemPhoto)
    const photo = item.getElementsByClassName('')
}
                ...
                {photosArr.map((img) => {
                    return <div className="card">
                        <div className="card__img">
                            ...
                            <button onClick={addToCart} className="card__hover__button"> <svg width="26" height="24" viewBox="0 0 33 29" fill="none" xmlns="http://www.w3.org/2000/svg">
